...
// Chargement dynamique du dashboard admin
...
const PlayerDashboard = () => (
  <div className="p-4 text-gray-300">
    Dashboard joueur à venir...
  </div>
)

const CaptainDashboard = () => (
  <div className="p-4 text-gray-300">
    Dashboard capitaine à venir...
  </div>
)
          ...
          roles[panel.key] && (
            ...
            >
              <button
                ...
                onClick={() =>
                  setOpenPanel(
                    openPanel === panel.key ? null : panel.key
                  )
                }
              >
                {panel.label}
