...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      // Récupère l'utilisateur Supabase connecté
      ...
      // Récupère le profil complet dans ta table users via auth_id
  ...
  if (loading) return <p className="text-white p-6">Chargement du dashboard...</p>
